"""
Epitech Iterative Optimization
==============================

Run multiple optimization iterations to maximize savings.
"""
...
def find_optimal_positions_aggressive(buildings, antennas, bmap):
    """Aggressively reposition antennas to cover more buildings."""
    cell_size = 200
            ...
            for dy in range(-4, 5):
                for candidate_b in grid[(cx_cell + dx, cy_cell + dy)]:
                    ...
                    for atype in ['Density', 'MaxRange', 'Spot', 'Nano']:
                        ...
                        # Check all nearby cells for additional buildings
                        ...
                        break  # Found valid type, no need to try cheaper ones
        ...
        for dx in range(-3, 4):
            for dy in range(-3, 4):
                for j in grid[(cx + dx, cy + dy)]:
                    ...
                    # Try both positions and centroid
                    positions = [
                        (a1['x'], a1['y']),
                        (a2['x'], a2['y']),
                    ]
...
def main():
    ...
    with open('./solutions/solution_4_epitech_40445000.json') as f:
        sol = json.load(f)
    ...
    for iteration in range(10):
        ...
        antennas, improved = find_optimal_positions_aggressive(buildings, best_antennas, bmap)
